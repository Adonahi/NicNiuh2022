...
public class ContactoFragment extends Fragment {
    ...
    View vista;
    FloatingActionButton fabTelefono, fabMaps;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabTelefono = vista.findViewById(R.id.fab_telefono);
        fabMaps = vista.findViewById(R.id.fabMaps);

        fabTelefono.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentTelefono = new Intent(Intent.ACTION_CALL, Uri.parse("tel: 5510045999"));
        ...
        fabMaps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentMaps = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:0,0?q=19.367389360117336, -99.03555375372491(NicNiuh)"));
